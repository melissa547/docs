...
Arrays Nanopayment lets your code or AI agent call our API and **pay per request in USDC** using the [x402 HTTP standard](https://x402.org) and [Circle Gateway](https://www.circle.com/gateway).
